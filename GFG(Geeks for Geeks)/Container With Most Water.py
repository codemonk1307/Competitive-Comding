...
"""
Container With Most Water -> Problem Statement( https://www.geeksforgeeks.org/problems/container-with-most-water0535/1 )
...
class Solution:
    def maxWater(self, arr):
        ...
        while left < right:
            # Calculate area for the current pointers
            width = right - left
